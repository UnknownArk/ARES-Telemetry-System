          ...
          <form onSubmit={streamTelemetry} className="panel-glass p-6 space-y-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-3 bg-zinc-100 hover:bg-white disabled:bg-zinc-800 text-black font-bold font-mono text-xs rounded tracking-widest transition-colors"
              >
