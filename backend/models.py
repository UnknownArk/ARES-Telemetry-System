...
class Agency(Base):
    ...
    fleet=relationship("Spacecraft",back_populates="agency",cascade="all,delete-orphan")
...
class Mission(Base):
    ...
    id = Column(Integer, primary_key=True,index=True)
    spacecraft_id = Column(Integer, ForeignKey("spacecrafts.id", ondelete="SET NULL"), nullable=True)
