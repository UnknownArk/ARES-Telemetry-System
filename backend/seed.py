...
def seed_database():
    ...
    historical_missions = [
        ...
        Mission(
            ...
            launch_date=date(1977, 9, 5),
            status="Active (Legacy)",
        ),
        Mission(
            name="James Webb Space Telescope",
            target_destination="Sun-Earth L2 Lagrange Point",
    ...
    try:
        ...
        db.commit()
        print(
            f"Successfully injected {len(historical_missions)} historical missions into the A.R.E.S. database."
        )
